	...
	<hr>
		<section style="margin-right:5%;">
			...
			<?php 
				...
				{
					echo "<form name="."f1"." action="."contactus.php"." method="."post".">";
		...
		<img src="logo.png" style="float:right;">
			<div>
				...
				<h2 style="font-family:calibri;color:red;">Contact Details</h2>
				<table width="400px" border="1px solid black">
					<tr>
						<td>Toll Free Number:</td><td>1800 180 9090</td>
					</tr>
					<tr>
						<td>Other Number:</td><td>9800980980</td>
					</tr>
					<tr>
						<td>Or write to us:</td><td>customermanage@redbus.com</td>
					</tr>
				</table>
