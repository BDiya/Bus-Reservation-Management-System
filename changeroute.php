...
<form name="f1" action="try21.php" method="post">
...
echo "<tr> <td> <a href=''> Feedback Reply</a></td></tr>";
echo "<tr> <td> <a href='Aboutus.html'> About Us</a></td></tr>";
echo "<tr> <td> <a href='logout.php'> Logout</a></td></tr>";
echo "</table>";
echo "</section>";
echo '<div id="pl">

<h3>Bus Id:   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="busid" value=""></h3>
<h3>Click to: &nbsp;&nbsp;  <input type="submit" name="sub" value="Change Route"></h3>
</div>
<div id="ft">
<hr>
